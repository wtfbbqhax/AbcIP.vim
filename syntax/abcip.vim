...
syn region abcABRegion start="(" end=")"
  \ contains=abcString,abcComment,abcProtoName,abcProtoIndex,abcProtoOptions,abcNumber fold
...
~/eicar $ cat ~/.vim/syntax/abcip.vim
" Language: ABCIP
" Maintainer: Victor Roemer <victor@badsec.org>
" Last Change: 2023 June 6
