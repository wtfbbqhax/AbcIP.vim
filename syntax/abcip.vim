...
syn keyword abcProtoName contained arp dst6 eth frag6 gre hop6 icmp4 icmp6 ip4 ip6 
syn keyword abcProtoName contained modbus mpls phy ppp pppoe raw rte6 tcp udp vlan
...
" ABCIP Regions
syn region abcDefinedRegion start="\<\([A-Za-z]+:\)d\s*(" skip="\n" end=")"
    \ contains=abcString,abcComment,abcDefineKeyword,abcNumber fold

syn region abcConfigRegion start="\<c\s*(" skip="\n" end=")"
    \ contains=abcString,abcComment,abcConfigKeyword,abcNumber,abcProtoName fold

syn region abcABRegion start="(" end=")"
    \ contains=abcString,abcComment,abcABKeyword,abcNumber,abcProtoName fold
